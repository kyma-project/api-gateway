...
| **status.RequestAuthenticationStatus.code** | Status code describing the Istio RequestAuthentication resource. |
| **status.RequestAuthenticationStatus.desc** | Current state of the Istio RequestAuthentication resource. |
| **status.AuthorizationPolicyStatus.code** | Status code describing the Istio AuthorizationPolicy resource. |
| **status.AuthorizationPolicyStatus.desc** | Current state of the Istio AuthorizationPolicy resource. |
