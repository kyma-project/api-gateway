...
// +kubebuilder:deprecatedversion:warning=APIRule version v1beta1 is deprecated in favor of v1beta2. You need to migrate to v1beta2. We plan to remove v1beta1 in xx.2024.
