...
var beta1toV2alpha1StatusConversionMap = map[v1beta1.StatusCode]v2alpha1.State{
	v1beta1.StatusOK:      v2alpha1.Ready,
	v1beta1.StatusError:   v2alpha1.Error,
	v1beta1.StatusWarning: v2alpha1.Warning,
	...
	v1beta1.StatusSkipped: v2alpha1.Warning,
}

func convertMap(m map[v1beta1.StatusCode]v2alpha1.State) map[v2alpha1.State]v1beta1.StatusCode {
	inv := make(map[v2alpha1.State]v1beta1.StatusCode)
	for k, v := range m {
		inv[v] = k
	}
	return inv
...
func (apiRule *APIRule) ConvertFrom(hub conversion.Hub) error {
	...
	if apiRuleBeta1.Spec.CorsPolicy != nil {
		...
		apiRule.Spec.CorsPolicy.AllowOrigins = v2alpha1.StringMatch(apiRuleBeta1.Spec.CorsPolicy.AllowOrigins)
	...
	if annotation, ok := apiRuleBeta1.Annotations[v2alpha1RulesAnnotationKey]; ok {
		...
		for _, ruleBeta1 := range apiRuleBeta1.Spec.Rules {
			...
			if ruleBeta1.Mutators != nil {
				ruleV1Alpha2.Request = &v2alpha1.Request{}
			}
