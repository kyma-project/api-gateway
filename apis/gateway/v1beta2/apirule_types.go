...
// Rule .
// +kubebuilder:validation:XValidation:rule="has(self.jwt) ? self.noAuth != true : self.noAuth == true",message="either jwt is configured or noAuth must be set to true in a rule"
type Rule struct {
