...
var _ = Describe("Mutators", func() {
	...
	Describe("CookieMutatorConfig ToString", func() {
		...
		It("should return string with cookies", func() {
			sut := v1beta2.CookieMutatorConfig{Cookies: map[string]string{"cookie1": "value1", "cookie2": "value2"}}
