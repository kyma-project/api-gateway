...
func (in *APIGatewaySpec) DeepCopyInto(out *APIGatewaySpec) {
	*out = *in
	if in.EnableKymaGateway != nil {
		in, out := &in.EnableKymaGateway, &out.EnableKymaGateway
		*out = new(bool)
		**out = **in
	}
	if in.NetworkPoliciesEnabled != nil {
		in, out := &in.NetworkPoliciesEnabled, &out.NetworkPoliciesEnabled
		*out = new(bool)
		**out = **in
	}
}
