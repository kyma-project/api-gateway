...
The structure of the `v2alpha1` API is defined in [`v2alpha1` custom resource documentation](https://github.com/kyma-project/api-gateway/blob/release-3.1/docs/user/custom-resources/apirule/v1beta1-deprecated/04-10-apirule-custom-resource.md).
