Release 3.1.0 of the API Gateway module changes the stored version of APIRule to `v2alpha1`. This is the next step in the migration process to the `v2` version and the removal of the `v1beta1` version. #1777
## Bug Fixes
