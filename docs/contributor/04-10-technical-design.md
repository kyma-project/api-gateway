...
The controller is responsible for handling the a Secret CR name `api-gateway-webhook-certificate` in `kyma-system` that is holding Certificate data needed for the APIRule conversion webhook.
