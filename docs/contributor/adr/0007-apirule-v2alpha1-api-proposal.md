...
| **rules.path**                                   |  **YES**  | Specifies the path of the exposed Service. If the configured path of a rule overlaps with the path of another rule, e.g. if a rule defines `/*` in the path, the configuration of both rules is applied.                                                                                                                                      | Value can be either exact path or the wildcard path `/*`.                                                                                                                                                                               |
