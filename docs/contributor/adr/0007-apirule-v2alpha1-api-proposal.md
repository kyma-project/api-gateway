...
| **hosts**                                        |  **YES**  | Specifies the Service's communication address for inbound external traffic. If only the leftmost label is provided, the domain name from the referenced Gateway is used, expanding the host to `<label>.<gateway domain>`.                                                                                                                   | The wildcard character `*` is allowed only as the leftmost label of the host (e.g., `*.example.com`).                                                                                                                                                     |
...
| **rules.mutators**                               |  **NO**   | Specifies the list of the request mutators.                                                                                                                                                                                                                                                                                                  | Currently, the `Headers` and `Cookie` mutators are supported. For more information, see [APIRule Mutators](https://github.com/kyma-project/api-gateway/blob/release-3.1/docs/user/custom-resources/apirule/v1beta1-deprecated/04-40-apirule-mutators.md). |
...
| **rules.jwt**                                    |  **NO**   | Specifies the Istio JWT access strategy. For more information, see [JWT Access Strategy](https://github.com/kyma-project/api-gateway/blob/release-3.1/docs/user/custom-resources/apirule/v1beta1-deprecated/04-20-apirule-istio-jwt-access-strategy.md).                                                                                     |
