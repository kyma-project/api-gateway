...
| Name                                                                                                                                                                                                              | Description                                                                                                                                                                |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [`PR Integration Release / Build and push manager image`](https://github.com/kyma-project/api-gateway/blob/0e7159413759f1e0627429e727fecc30d147e328/.github/workflows/pull-integration-release.yaml#L43)    | Builds the managers's image and pushs it to a GCP Artifact Registry so that the jobs running tests on Gardener clusters can be executed.            |
