...
| [`PR Build and Push Manager Image / Build and push manager image`](xxx)| Builds the managers's image and pushs it to a GCP Artifact Registry so that the jobs running tests on Gardener clusters can be executed.               |
