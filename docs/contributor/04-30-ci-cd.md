...
| [`Main Integration / Get SHA`](https://github.com/kyma-project/api-gateway/blob/b3a5e3d396cf3660bdf19a5694e1c0194a3a3e5b/.github/workflows/main-integration.yaml#L33)                       | Extracts the SHA that's used to define what API Gateway image is used during tests.                                                                                        |
