...
| [`pull-gitleaks / scan`](https://github.com/kyma-project/api-gateway/blob/main/.github/workflows/pull-gitleaks.yaml#L10)                                                                          | Runs gitleaks scan to detect any secrets leaks.                                                                                                              |
