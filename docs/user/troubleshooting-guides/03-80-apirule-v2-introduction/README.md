# Troubleshooting Guides - APIRule v2 Introduction
...
- [APIRule `v2alpha1` Contains an Empty Spec](./03-84-empty-apirule-v2alpha1-spec.md)
- [APIRule `v2` Contains a Changed Status Schema](./03-82-changed-status-schema-apirule-v2.md)
- [Missing Hosts in APIRules List](./03-83-missing-hosts-in-apirules-list.md)