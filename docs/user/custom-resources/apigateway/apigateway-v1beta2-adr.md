...
| **rules.accessStrategy**        |  **NO**   | Specifies the list of access strategies.                                                                                                                                                                                                                                                                                                     | Supported are `extAuth` and `jwt` as [Istio](https://istio.io/latest/docs/tasks/security/authorization/authz-jwt/) access strategy.                                                                                              |
