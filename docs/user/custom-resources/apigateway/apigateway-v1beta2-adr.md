...
| **rules.accessStrategy**         |  **NO**   | Specifies the access strategy.                                                                                                                                                                                                                                                                                                               | Supported are `extAuth` or `jwt` as [Istio](https://istio.io/latest/docs/tasks/security/authorization/authz-jwt/) access strategy.                                                                                               |
| **rules.accessStrategy.extAuth** |  **NO**   | Specifies the list of external authorizers. For more information see the [External Authorizer ADR](https://github.com/kyma-project/api-gateway/issues/938).                                                                                                                                                                                  |                                                                                                                                                                                                                                  |
| **rules.accessStrategy.jwt**     |  **NO**   | Specifies the Istio JWT access strategy. For more information see the [documentation](https://github.com/kyma-project/api-gateway/blob/main/docs/user/custom-resources/apirule/04-20-apirule-istio-jwt-access-strategy.md).                                                                                                                  |                                                                                                                                                                                                                                  |
