...
|---------------------------------------|----------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **selectorLabels**                    | **YES**  | Labels that specify the set of Pods to which the configuration applies.<br/> Each Pod must match only one RateLimit CR.<br/> The label scope is limited to the namespace where the resource is located.                                                                                                                                                                                             |
