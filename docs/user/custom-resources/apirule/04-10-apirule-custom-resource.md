...
| **externalGateway** <br /> string | Specifies the ExternalGateway. The field must reference an existing ExternalGateway in the cluster.<br />Provide the ExternalGateway in the format `namespace/externalgateway`.<br />Both the namespace and the ExternalGateway name cannot be longer than 63 characters each.<br />Mutually exclusive with Gateway. | MaxLength: 127 <br /> |
