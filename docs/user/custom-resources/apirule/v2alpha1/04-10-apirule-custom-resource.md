...
| **hosts**                                        |  **YES**  | Specifies the Service's communication address for inbound external traffic. It is expected to be a fully qualified domain name.                                                                                                                                                       | It should be proper FQDN format: at least 2 domain labels with characters, numbers or dashes.         |
