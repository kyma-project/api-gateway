...
| **hosts**                                        | **YES**  | Specifies the Service's communication address for inbound external traffic. It must be a short host name or a valid fully qualified domain name (FQDN) in format: at least two domain labels with characters, numbers, or hypens.                                                          | Short host name or FQDN format.                                                                                                               |
