...
> [!WARNING]
> APIRule CR in version `v1beta1` has been deprecated and will be removed on May 12, 2025. Version `v2alpha1`, introduced for testing purposes, will become deprecated oApril 15n , 2025, and removed on June 16, 2025. The stable APIRule `v2` is planned to be introduced in the regular channel on April 15, 2025.
> 
