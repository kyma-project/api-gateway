export default [
  ...
  { text: 'Tutorials', link: './tutorials/README', collapsed: true, items: [
    ...
    { text: 'Secure a Workload with extAuth (Client Credentials Flow)', link: './tutorials/01-53-expose-and-secure-workload-extauth-client-credentials.md' },
    { text: 'Secure a Workload with extAuth (Authorization Code Flow)', link: './tutorials/01-53-expose-and-secure-workload-extauth-authorization-code.md' },
