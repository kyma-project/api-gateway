...
func DeleteXFCCSanitizationFilter(ctx context.Context, k8sClient client.Client, gatewayName string) error {
	filterName := fmt.Sprintf("%s-xfcc-sanitization", gatewayName)
