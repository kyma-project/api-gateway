...
//			reconciliation := v2alpha1.NewReconciliation(v2alpha1ApiRule, nil, nil, GetTestConfig(), &testLogger, false)
...
//		// when
//		var createdObjects []client.Object
//		reconciliation := v2alpha1.NewReconciliation(v2alpha1ApiRule, nil, nil, GetTestConfig(), &testLogger, true)
//		for _, processor := range reconciliation.GetProcessors() {
//			results, err := processor.EvaluateReconciliation(context.Background(), fakeClient)
//			Expect(err).To(BeNil())
//			for _, result := range results {
...
//		reconciliation := v2alpha1.NewReconciliation(v2alpha1ApiRule, nil, &apiRuleValidatorMock, GetTestConfig(), &testLogger, false)
//
