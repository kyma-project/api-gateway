...
func NewMigrationProcessors(apiRuleV2alpha1 *gatewayv2alpha1.APIRule, config processing.ReconciliationConfig, log *logr.Logger) []processing.ReconciliationProcessor {
