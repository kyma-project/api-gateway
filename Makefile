...
test-integration: generate fmt vet envtest ## Run integration tests.
	source ./tests/integration/env_vars.sh && TEST_CONCURRENCY=1 go test -timeout 1h ./tests/integration -v -race -run TestIstioJwt . && TEST_CONCURRENCY=1 go test -timeout 1h ./tests/integration -v -race -run TestOryJwt . && TEST_CONCURRENCY=1 go test -timeout 1h ./tests/integration -v -race -run TestGateway .
