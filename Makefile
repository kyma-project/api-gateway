...
test-integration-v2alpha1: ## Run API Gateway integration tests with v2alpha1 API.
...
.PHONY: test-upgrade
test-upgrade: generate-upgrade-test-manifest install-istio deploy-latest-release ## Run API Gateway upgrade tests.
...
test-integration-v2: ## Run API Gateway integration tests with v2 API.
