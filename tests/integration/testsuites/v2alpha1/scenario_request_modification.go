...
func initRequestHeaders(ctx *godog.ScenarioContext, ts *testsuite) {
	...
	ctx.Step(`RequestHeader: Calling the "([^"]*)" endpoint should return response with header "([^"]*)" with value "([^"]*)"$`, scenario.callinTheEndpointShouldResultInBodyContaining)
...
func initRequestCookies(ctx *godog.ScenarioContext, ts *testsuite) {
	...
	ctx.Step(`RequestCookie: Calling the "([^"]*)" endpoint should return response with cookie "([^"]*)" with value "([^"]*)"$`, scenario.callinTheEndpointShouldResultInBodyContaining)
