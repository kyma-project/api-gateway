Feature: Exposing service using asterisks
  ...
  Scenario: Exposure of service using asterisks in paths
    ...
    Then Calling the "/anything/one" endpoint with "GET" method should result in status between 200 and 200
    And Calling the "/anything/one/two" endpoint with "GET" method should result in status between 200 and 200
    And Calling the "/anything/random/one" endpoint with "GET" method should result in status between 200 and 200
