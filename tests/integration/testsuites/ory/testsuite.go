...
func (t *testsuite) BeforeSuiteHooks() []func() error {
	return []func() error{hooks.ExtAuthorizerInstallHook(t), hooks.ApplyAndVerifyApiGatewayCrSuiteHook, hooks.DisableV2Alpha1RequiredFieldsHook}
}
