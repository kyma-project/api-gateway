...
var apiGatewayResources = []resourceCheck{
	...
	{
		gvk:       schema.GroupVersionKind{Group: "dns.gardener.cloud", Version: "v1alpha1", Kind: "DNSEntry"},
		name:      "kyma-gateway",
		namespace: "kyma-system",
	},
	{
	...
	{
		gvk:       schema.GroupVersionKind{Group: "cert.gardener.cloud", Version: "v1alpha1", Kind: "Certificate"},
		name:      "kyma-tls-cert",
		namespace: "istio-system",
	},
}
